package io.github.mangocrisp.exp.wsr.controller;
...
public class MsgController {
    ...
    final IWebSocketServer<WebsocketReactiveSession> webSocketServer;

    @RequestMapping("/send")
    public Mono<?> sendMessage(@RequestParam Long toUserId
        ...
        return Mono.just(String.format("Message '%s' sent to connection: %s.", data, toUserId));
    }
